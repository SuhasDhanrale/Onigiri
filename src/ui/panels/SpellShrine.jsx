    ...
    <div>
      <div className="flex justify-between items-end border-b-2 border-[#1b1918] pb-1 mb-2">
        ...
        {!s.heroUnlocked && (
          <button 
            ...
            className="text-[8px] font-black uppercase border border-[#d4af37] bg-[#d4af37] text-[#1b1918] hover:bg-[#1b1918] hover:text-[#d4af37] px-2 disabled:opacity-50"
          >
            Unlock Hero (500K)
          </button> 
        )}
      ...
      <div className="flex flex-col gap-1.5">
        <button 
          ...
          className="relative group w-full flex justify-between items-baseline px-3 py-1.5 transition-all border-2 bg-[#1b1918] text-[#38bdf8] border-[#38bdf8] hover:bg-[#38bdf8] hover:text-[#1b1918] disabled:opacity-50 disabled:border-[#1b1918] disabled:text-[#8b8574]"
        >
        ...
        <button 
          ...
          className="relative group w-full flex justify-between items-baseline px-3 py-1.5 transition-all border-2 bg-[#1b1918] text-[#ea580c] border-[#ea580c] hover:bg-[#ea580c] hover:text-[#1b1918] disabled:opacity-50 disabled:border-[#1b1918] disabled:text-[#8b8574]"
        >
          <span className="text-[9px] font-bold tracking-widest uppercase">
        ...
        <button 
          ...
          className="relative group w-full flex justify-between items-baseline px-3 py-1.5 transition-all border-2 bg-[#1b1918] text-[#d4af37] border-[#d4af37] hover:bg-[#d4af37] hover:text-[#1b1918] disabled:opacity-50 disabled:border-[#1b1918] disabled:text-[#8b8574]"
        >
          <span className="text-[9px] font-bold tracking-widest uppercase">

    ...
    <div>
      ...
      <div className="flex flex-col gap-1.5">
        <button 
          ...
          className="relative group w-full flex justify-between items-baseline px-3 py-1.5 transition-all border-2 bg-[#e8e0cc] border-[#1b1918] hover:bg-[#1b1918] hover:text-[#dfd4ba] disabled:opacity-50 disabled:bg-[#cfc4af] disabled:text-[#8b8574] disabled:border-[#8b8574]"
        >
